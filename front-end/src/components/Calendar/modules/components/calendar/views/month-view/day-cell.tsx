...
import { transition } from "@/components/Calendar/modules/components/calendar/animations";
import { EventListDialog } from "@/components/Calendar/modules/components/calendar/dialogs/events-list-dialog";
import { DroppableArea } from "@/components/Calendar/modules/components/calendar/dnd/droppable-area";
import { getMonthCellEvents } from "@/components/Calendar/modules/components/calendar/helpers";
import { useMediaQuery } from "@/components/Calendar/modules/components/calendar/hooks";
import type {
  ICalendarCell,
  IEvent,
...
import { MonthEventBadge } from "@/components/Calendar/modules/components/calendar/views/month-view/month-event-badge";
